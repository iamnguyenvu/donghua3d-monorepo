...
const CORE_TRACKED_SLUGS = [
  ...
  'tru-tien-phan-2',
  'tru-tien-phan-3',
  'ma-thoi-den-tinh-tuyet-co-thanh',
  'ma-thoi-den-me-dong-long-linh',
  'ma-thoi-den-van-nam-trung-coc',
  'ma-thoi-den-nam-hai-quy-hu-2023',
  'linh-lung-hoat-hinh',
  'ling-cage-season-2',
